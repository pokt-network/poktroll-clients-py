...
import pocket.application.params_pb2
...
class QueryParamsResponse(google.protobuf.message.Message):
    ...
    @property
    def params(self) -> pocket.application.params_pb2.Params:
        """params holds all the parameters of this module."""

    def __init__(
        self,
        *,
        params: pocket.application.params_pb2.Params | None = ...,
    ) -> None: ...
...
class QueryAllApplicationsRequest(google.protobuf.message.Message):
    ...
    DELEGATEE_GATEWAY_ADDRESS_FIELD_NUMBER: builtins.int
    delegatee_gateway_address: builtins.str
    ...
    def ClearField(self, field_name: typing.Literal["delegatee_gateway_address", b"delegatee_gateway_address", "pagination", b"pagination"]) -> None: ...
...
class QueryAllApplicationsResponse(google.protobuf.message.Message):
    ...
    PAGINATION_FIELD_NUMBER: builtins.int
    @property
    def applications(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[pocket.application.types_pb2.Application]: ...
    @property
    def pagination(self) -> cosmos.base.query.v1beta1.pagination_pb2.PageResponse: ...
    def __init__(
        self,
        *,
        applications: collections.abc.Iterable[pocket.application.types_pb2.Application] | None = ...,
