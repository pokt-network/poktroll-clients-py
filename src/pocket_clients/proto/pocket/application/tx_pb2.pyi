...
class MsgStakeApplication(google.protobuf.message.Message):
    ...
    @property
    def services(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[pocket.shared.service_pb2.ApplicationServiceConfig]:
    ...
    def __init__(
        ...
        *,
        ...
        services: collections.abc.Iterable[pocket.shared.service_pb2.ApplicationServiceConfig] | None = ...,
    ) -> None: ...
