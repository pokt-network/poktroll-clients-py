...
class Params(google.protobuf.message.Message):
    ...
    GATEWAY_UNBONDING_PERIOD_SESSIONS_FIELD_NUMBER: builtins.int
    ...
    """
    gateway_unbonding_period_sessions: builtins.int
