...
import pocket.shared.params_pb2
import typing
...
class MsgUpdateParams(google.protobuf.message.Message):
    ...
    @property
    def params(self) -> pocket.shared.params_pb2.Params:
    ...
    def __init__(
        ...
        *,
        authority: builtins.str = ...,
        params: pocket.shared.params_pb2.Params | None = ...,
    ) -> None: ...
...
class MsgUpdateParam(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["as_bytes", b"as_bytes", "as_string", b"as_string", "as_type", b"as_type", "as_uint64", b"as_uint64"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["as_bytes", b"as_bytes", "as_string", b"as_string", "as_type", b"as_type", "as_uint64", b"as_uint64", "authority", b"authority", "name", b"name"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["as_type", b"as_type"]) -> typing.Literal["as_string", "as_uint64", "as_bytes"] | None: ...
