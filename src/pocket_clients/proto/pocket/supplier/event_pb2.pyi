...
@typing.final
class EventSupplierServiceConfigActivated(google.protobuf.message.Message):
    ...
    SUPPLIER_FIELD_NUMBER: builtins.int
    ACTIVATION_HEIGHT_FIELD_NUMBER: builtins.int
    activation_height: builtins.int
    ...
    def HasField(self, field_name: typing.Literal["supplier", b"supplier"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["activation_height", b"activation_height", "supplier", b"supplier"]) -> None: ...

global___EventSupplierServiceConfigActivated = EventSupplierServiceConfigActivated
