...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_EVENTRELAYMININGDIFFICULTYUPDATED']._serialized_start=69
  _globals['_EVENTRELAYMININGDIFFICULTYUPDATED']._serialized_end=353
