...
class MsgUpdateParam(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["as_coin", b"as_coin", "as_type", b"as_type", "as_uint64", b"as_uint64"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["as_coin", b"as_coin", "as_type", b"as_type", "as_uint64", b"as_uint64", "authority", b"authority", "name", b"name"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["as_type", b"as_type"]) -> typing.Literal["as_coin", "as_uint64"] | None: ...
