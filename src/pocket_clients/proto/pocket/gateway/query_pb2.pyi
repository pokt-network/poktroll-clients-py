...
class QueryAllGatewaysResponse(google.protobuf.message.Message):
    ...
    PAGINATION_FIELD_NUMBER: builtins.int
    @property
    def gateways(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[pocket.gateway.types_pb2.Gateway]: ...
    @property
    def pagination(self) -> cosmos.base.query.v1beta1.pagination_pb2.PageResponse: ...
    def __init__(
        self,
        *,
        gateways: collections.abc.Iterable[pocket.gateway.types_pb2.Gateway] | None = ...,
