...
import pocket.tokenomics.types_pb2
import sys
import typing
...
class EventClaimSettled(google.protobuf.message.Message):
    ...
    proof_requirement: pocket.proof.types_pb2.ProofRequirementReason.ValueType
    ...
    @property
    def settlement_result(self) -> pocket.tokenomics.types_pb2.ClaimSettlementResult:
    ...
    def __init__(
        ...
        *,
        ...
        num_estimated_compute_units: builtins.int = ...,
        claimed_upokt: cosmos.base.v1beta1.coin_pb2.Coin | None = ...,
        settlement_result: pocket.tokenomics.types_pb2.ClaimSettlementResult | None = ...,
    ) -> None: ...
