...
class Session(google.protobuf.message.Message):
    ...
    @property
    def suppliers(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[pocket.shared.supplier_pb2.Supplier]:
    ...
    def __init__(
        ...
        *,
        ...
        suppliers: collections.abc.Iterable[pocket.shared.supplier_pb2.Supplier] | None = ...,
    ) -> None: ...
