...
import pocket.session.params_pb2
...
class QueryParamsResponse(google.protobuf.message.Message):
    ...
    @property
    def params(self) -> pocket.session.params_pb2.Params:
        """params holds all the parameters of this module."""

    def __init__(
        self,
        *,
        params: pocket.session.params_pb2.Params | None = ...,
    ) -> None: ...
...
class QueryGetSessionResponse(google.protobuf.message.Message):
    ...
    @property
    def session(self) -> pocket.session.types_pb2.Session: ...
    def __init__(
        self,
        *,
        session: pocket.session.types_pb2.Session | None = ...,
    ) -> None: ...
