...
from pocket_clients.proto.tendermint.consensus import types_pb2 as tendermint_dot_consensus_dot_types__pb2
from pocket_clients.proto.tendermint.types import events_pb2 as tendermint_dot_types_dot_events__pb2
